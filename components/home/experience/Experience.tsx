...
const experience = [
  ...
  },
  {
    ...
    location: "Nošovice - Czech Republic",
    description:
      "Process Engineer on Assembly factory. Responsible for electrical processes of Manufacturing Vehicles. Managing coding equipment, new equipment installation, and improvements of installed equipment, to install larger components.",
  ...
  },
  {
    ...
    description:
      "Industrial Engineer in Manufacturing of settopbox, TV, Personal Computers.",
    tech: ["AutoCAD", "Office"],
  },
];
